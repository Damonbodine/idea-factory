...
export default function Design16() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-500 to-blue-500 text-white">
      <nav className="px-8 py-6">
        <div className="flex justify-between items-center">
          <div className="text-3xl font-black">AGENCY</div>
          <div className="hidden md:flex gap-8">
            <a href="#" className="hover:text-pink-200 transition">Services</a>
            <a href="#" className="hover:text-pink-200 transition">Work</a>
      ...
      <main className="container mx-auto px-8 py-20">
        ...
        >
          ...
          <button className="px-8 py-4 bg-white text-pink-600 font-bold rounded-full flex items-center gap-3 hover:scale-105 transition">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          ...
          <div className="bg-white/10 backdrop-blur p-8 rounded-2xl">
            <Star className="w-12 h-12 mb-4 text-pink-300" />
